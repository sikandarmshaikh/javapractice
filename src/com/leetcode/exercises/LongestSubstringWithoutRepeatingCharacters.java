...
/**
 * Exabeam Interview Question
 * Find the longest non-repeating substring within a string
 * Input: GEEKSFORGEEKS, abcabcbb, bbbbb, pwwkew, ABDEFGABEF, BBBB
 * Output: EKSFORG, abc, b, wke, (BDEFGA & DEFGAB), B
 * 
 * 
 */
public class LongestSubstringWithoutRepeatingCharacters {
	...
	public static void main(String[] args)
	{
	   ...
	   //System.out.print(findLongestSubstring(str));
		...
		System.out.println("LongestSubstringWithoutRepeatingCharacters:: "+output);
	}
	...
	public static String findLongestSubstring(String str)
	{
	    ...
	    for (i = 1; i < n; i++)
	    {
	        ...
	        {
	            // If this character is present in hash then this character has previous occurrence, check if that occurrence is before or after starting
